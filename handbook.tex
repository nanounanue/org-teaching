...
\mycustomhandbooktitle{How to teach using org-mode for fun and profit}{Olivier Berger}{(2017-05-18)}{org-teaching - example lesson}
...
\begin{NOTES}
The first level outlines can be rendered as a "separating" slides which may get a different \texttt{reveal\_background} and \texttt{class="center"} slide layout, but that isn't automatic. See \hyperref[sec:orga22aa3c]{Section separators}.
\end{NOTES}

\subsection{Presenter notes / content for the handbook}
\label{sec:orge6bfb10}
...
\label{sec:orgfa20d3b}

\subsubsection{Babel powa}
\label{sec:orgf67bd7d}
...
\section{HowTo}
\label{sec:orgc1adafa}
\subsection{Use Emacs}
\label{sec:orgf9da31a}
...
\label{sec:org4b279c0}

Depending on how you installed org-reveal (\hyperref[sec:org6b154dd]{Git submodules} or otherwise), \texttt{org-reveal} may already be available.
...
\label{sec:org583b36d}

\subsubsection{Firefox issues ?}
\label{sec:orgdc96b29}
...
You may prefer to have a PDF variant of the slides (see \hyperref[sec:org90e5c98]{Printing slides}) in case.



\section{How it works / Installation}
\label{sec:org6f246a9}
\subsection{Use the source Luke}
\label{sec:orga794ab6}
...
\label{sec:orge29eb25}

\subsubsection{Reveal.js settings}
\label{sec:orgba14965}
...
\section{Annex}
\label{sec:orgcfb752e}

\subsection{Thanks}
\label{sec:orga4d9f33}
...
\label{sec:org7be3fbd}

\subsubsection{2016 at Telecom SudParis}
\label{sec:org8add0f6}
