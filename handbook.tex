...
\begin{NOTES}
The first level outlines can be rendered as a "separating" slides which may get a different \texttt{reveal\_background} and \texttt{class="center"} slide layout, but that isn't automatic. See \hyperref[sec:orgfe19c6c]{Section separators}.
\end{NOTES}

\subsection{Presenter notes / content for the handbook}
\label{sec:org71fb97c}
...
\label{sec:org7ab7de5}

\subsubsection{Babel powa}
\label{sec:org43d92d3}
...
\section{HowTo}
\label{sec:org207df2b}
\subsection{Use Emacs}
\label{sec:org97055a0}
...
\label{sec:orgaab7962}

Depending on how you installed org-reveal (\hyperref[sec:org9853005]{Git submodules} or otherwise), \texttt{org-reveal} may already be available.
...
\label{sec:org05bb97d}

\subsubsection{Firefox issues ?}
\label{sec:orgc62de44}
...
You may prefer to have a PDF variant of the slides (see \hyperref[sec:org96fa0ab]{Printing slides}) in case.



\section{How it works / Installation}
\label{sec:org12dd3db}
\subsection{Use the source Luke}
\label{sec:org4fc0b92}
...
\label{sec:orgebbc3f9}

\subsubsection{Reveal.js settings}
\label{sec:org351b5cf}
...
\section{Annex}
\label{sec:org8eb751d}

\subsection{Thanks}
\label{sec:org0a97642}
