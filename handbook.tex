...
\begin{NOTES}
The first level outlines can be rendered as a "separating" slides which may get a different \texttt{reveal\_background} and \texttt{class="center"} slide layout, but that isn't automatic. See \hyperref[sec:org6da0630]{Section separators}.
\end{NOTES}

\subsection{Presenter notes / content for the handbook}
\label{sec:orgd9ee8d1}
...
\label{sec:org943817d}

\subsubsection{Babel powa}
\label{sec:orgcee177c}
...
\section{HowTo}
\label{sec:org656bc96}
\subsection{Use Emacs}
\label{sec:org542da6a}
...
\label{sec:org26ad4b0}

Depending on how you installed org-reveal (\hyperref[sec:org3c06a60]{Git submodules} or otherwise), \texttt{org-reveal} may already be available.
...
\label{sec:orgdd5aa92}

\subsubsection{Firefox issues ?}
\label{sec:orgfda45b7}
...
You may prefer to have a PDF variant of the slides (see \hyperref[sec:org57a96e1]{Printing slides}) in case.



\section{How it works / Installation}
\label{sec:org585e2c2}
\subsection{Use the source Luke}
\label{sec:org57b481b}
...
\label{sec:org201a977}

\subsubsection{Reveal.js settings}
\label{sec:org0524381}
...
\section{Annex}
\label{sec:org4139efd}

\subsection{Thanks}
\label{sec:org4025a90}
