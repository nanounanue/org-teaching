...
\begin{NOTES}
The first level outlines can be rendered as a "separating" slides which may get a different \texttt{reveal\_background} and \texttt{class="center"} slide layout, but that isn't automatic. See \hyperref[sec:orgdf557ee]{Section separators}.
\end{NOTES}

\subsection{Presenter notes / content for the handbook}
\label{sec:orga454ad4}
...
\label{sec:org75e07f3}

\subsubsection{Babel powa}
\label{sec:org5e7d267}
...
\section{HowTo}
\label{sec:org4c6136e}
\subsection{Use Emacs}
\label{sec:orgeeb37b3}
...
\label{sec:org31842b8}

Depending on how you installed org-reveal (\hyperref[sec:org3490b6d]{Git submodules} or otherwise), \texttt{org-reveal} may already be available.
...
\label{sec:org496d507}

\subsubsection{Firefox issues ?}
\label{sec:org70388bd}
...
You may prefer to have a PDF variant of the slides (see \hyperref[sec:orgf5c5e6a]{Printing slides}) in case.
...
\section{Annex}
\label{sec:org27fd905}

\subsection{Thanks}
\label{sec:org883c6de}
