...
\begin{NOTES}
The first level outlines can be rendered as a "separating" slides which may get a different \texttt{reveal\_background} and \texttt{class="center"} slide layout, but that isn't automatic. See \hyperref[sec:org8bd79fa]{Section separators}.
\end{NOTES}

\subsection{Presenter notes / content for the handbook}
\label{sec:org132560b}
...
\label{sec:orgfc5d0af}

\subsubsection{Babel powa}
\label{sec:org1543757}
...
\section{Authoring}
\label{sec:orgefb2719}
\subsection{Modify only the lesson.org}
\label{sec:org02f7332}
...
\label{sec:org79ab2fa}

Depending on how you installed org-reveal (\hyperref[sec:org0134214]{Git submodules} or otherwise), \texttt{org-reveal} may already be available.
...
\label{sec:orgb1b2871}

\subsubsection{Firefox issues ?}
\label{sec:orge1c6567}
...
You may prefer to have a PDF variant of the slides (see \hyperref[sec:orge603fbe]{Printing slides}) in case.



\section{How it works / Installation}
\label{sec:orgce6cf35}
\subsection{Use the source (Luke)}
\label{sec:org4a8acda}
...
\label{sec:org9a4f024}

\subsubsection{Reveal.js settings}
\label{sec:org62ce0d5}
...
\section{Annex}
\label{sec:orgfb072f7}

\subsection{Thanks}
\label{sec:org7acf789}
