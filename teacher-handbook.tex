...
\begin{NOTES}
The first level outlines can be rendered as a "separating" slides which may get a different \texttt{reveal\_background} and \texttt{class="center"} slide layout, but that isn't automatic. See \hyperref[sec:org83746ef]{Section separators}.
\end{NOTES}

\subsection{Presenter notes / content for the handbook}
\label{sec:org79c3c04}
...
\label{sec:org557a333}

\subsubsection{Babel powa}
\label{sec:org7282ded}
...
\section{HowTo}
\label{sec:org8299e57}
\subsection{Use Emacs}
\label{sec:org63805e9}
...
\label{sec:orga1047a4}

Depending on how you installed org-reveal (\hyperref[sec:org7240012]{Git submodules} or otherwise), \texttt{org-reveal} may already be available.
...
\label{sec:org4fed82d}

\subsubsection{Firefox issues ?}
\label{sec:orgf6fe877}
...
You may prefer to have a PDF variant of the slides (see \hyperref[sec:org33fd77e]{Printing slides}) in case.



\section{How it works / Installation}
\label{sec:orgefb14fa}
\subsection{Use the source Luke}
\label{sec:orgb35a437}
...
\label{sec:org68304b5}

\subsubsection{Reveal.js settings}
\label{sec:org785ba4c}
...
\section{Annex}
\label{sec:orgd485c80}

\subsection{Thanks}
\label{sec:org3ef96db}
