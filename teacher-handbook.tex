...
\begin{NOTES}
The first level outlines can be rendered as a "separating" slides which may get a different \texttt{reveal\_background} and \texttt{class="center"} slide layout, but that isn't automatic. See \hyperref[sec:org1c77ec1]{Section separators}.
\end{NOTES}

\subsection{Presenter notes / content for the handbook}
\label{sec:orgfad2e74}
...
\label{sec:org8e92cf4}

\subsubsection{Babel powa}
\label{sec:org1a550b4}
...
\section{HowTo}
\label{sec:orgc46bb8e}
\subsection{Use Emacs}
\label{sec:org8772b05}
...
\label{sec:org8885800}

Depending on how you installed org-reveal (\hyperref[sec:orgc0120be]{Git submodules} or otherwise), \texttt{org-reveal} may already be available.
...
\label{sec:orgd1f4be9}

\subsubsection{Firefox issues ?}
\label{sec:org2161b72}
...
You may prefer to have a PDF variant of the slides (see \hyperref[sec:orgc166b60]{Printing slides}) in case.
