...
\begin{NOTES}
The first level outlines can be rendered as a "separating" slides which may get a different \texttt{reveal\_background} and \texttt{class="center"} slide layout, but that isn't automatic. See \hyperref[sec:orgd25a038]{Section separators}.
\end{NOTES}

\subsection{Presenter notes / content for the handbook}
\label{sec:org860a78c}
...
\label{sec:org0f3e34a}

\subsubsection{Babel powa}
\label{sec:orga8ad6bc}
...
\section{HowTo}
\label{sec:orgd96bef4}
\subsection{Use Emacs}
\label{sec:org3cf6293}
...
\label{sec:org8acee9b}

Depending on how you installed org-reveal (\hyperref[sec:org11e7929]{Git submodules} or otherwise), \texttt{org-reveal} may already be available.
...
\label{sec:orgb7fd098}

\subsubsection{Firefox issues ?}
\label{sec:org0e0ca7a}
...
You may prefer to have a PDF variant of the slides (see \hyperref[sec:org19833ec]{Printing slides}) in case.
...
\section{Annex}
\label{sec:orgb3139f8}

\subsection{Thanks}
\label{sec:orgd1561a8}
